...
<div class="card card-info">
    ...
    <div class="card-body">
        <form action="{{route('admin.product.update', $product_items->id)}}" method="post"
            ...
            <div class="input-group mb-3 input-size">
                ...
                <select style="width: 80%;" class="form-control ass js-example-basic-multiple" name="brand[]"
                        multiple="multiple">
                    @if(isset($brand))
                        <option value="">
                            انتخاب برند
                            ...
                            @for($i=0;$i<count($properties);$i++)
                                <tr style="row-span: 2 ;column-span: 2 ">
                                    <div>
                                        <td>
                                            <input
                                                value="{{$properties[$i]->title}}"
                                                placeholder="{{$properties[$i]->title}}"
                                        ...
                                        <td>
                                            <input
                                                placeholder="{{isset($properties_product[$i]) ? $properties_product[$i] : ''}}"
                                                style="display: inline-block; margin: 5px;width: 100%" type="text"
